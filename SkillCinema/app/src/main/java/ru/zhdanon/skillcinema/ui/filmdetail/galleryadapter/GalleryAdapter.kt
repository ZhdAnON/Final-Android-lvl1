...
class GalleryAdapter(
    private val clickImage: (filmId: ItemImageGallery) -> Unit
) : ListAdapter<ItemImageGallery, GalleryViewHolder>(DiffGallery()) {
    ...
    override fun onBindViewHolder(holder: GalleryViewHolder, position: Int) {
        holder.bindItem(getItem(position)) { clickImage(getItem(position)) }
    }
}